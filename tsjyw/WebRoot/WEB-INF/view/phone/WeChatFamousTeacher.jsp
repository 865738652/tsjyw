...
<div class="header-nav">
    <ul>
        ...
        <li class="nav-item on" data-urlpath="WeChatFamousTeacher">名师</li>
...
<div class="swiper-view">
    ...
    <script src="../newphone/famousteacher/js/index.js"></script>
...
<li class="mb30">
	<p class="company">幸福互动（北京）网络科技有限公司</p>
</li>
<li>
	<p class="copyright">Copyright © 2001-2016 87870.com All rights reserved</p>
</li>
</ul>
    </div>
