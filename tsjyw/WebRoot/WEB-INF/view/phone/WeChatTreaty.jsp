...
<head>
    ...
    <title>《唐山家庭教育网网络服务协议》</title>
      <script type="text/javascript">
    	function Treaty()
    	{
    		window.location.href="WeChatTreaty"; 
    	}
...
<div>
	...
	<h3>一、总则</h3>
		 ...
		 <p>&nbsp;&nbsp;&nbsp;1.1、唐山家庭教育网的所有权和运营权归唐山市睿智文化交流有限公司、唐山市教育局所有。</p>
		 <p>&nbsp;&nbsp;&nbsp;1.2、用户在注册之前，应当仔细阅读本协议，并同意遵守本协议后方可成为注册用户。一旦注册成功，则用户与唐山家庭教育网之间自动形成协议关系，用户应当受本协议的约束。用户在使用特殊的服务或产品时，应当同意接受相关协议后方能使用。</p>
		 <p>&nbsp;&nbsp;&nbsp;1.3、本协议可由唐山家庭教育网随时更新，用户应当及时关注并同意本站不承担通知义务。本站的通知、公告、声明或其它类似内容是本协议的一部分。 </p>
	<h3>二、服务内容</h3> 
		<p>&nbsp;&nbsp;&nbsp;2.1、唐山家庭教育网的具体内容由本站根据实际情况提供。 </p>
		<p>&nbsp;&nbsp;&nbsp;2.2、本站仅提供相关的网络服务，除此之外与相关网络服务有关的设备(如个人电脑、手机、及其他与接入互联网或移动网有关的装置)及所需的费用(如为接入互联网而支付的电话费及上网费、为使用移动网而支付的手机费)均应由用户自行负担。</p>
		<h3>三、用户帐号</h3>
		<p>&nbsp;&nbsp;&nbsp;3.1、经本站注册系统完成注册程序并通过身份认证的用户即成为正式用户，可以获得本站规定用户按规则所应享有的一切权限；未经认证仅享有本站规定的部分权限。唐山家庭教育网有权对会员的权限设计进行变更。</p> 
		<p>&nbsp;&nbsp;&nbsp;3.2、用户只能按照注册要求使用真实姓名，及身份证号、邮箱注册。用户有义务保证密码和帐号的安全，用户利用该密码和帐号（或因密码、账号丢失、被盗）所进行（引起）的一切活动引起的任何损失或损害，由用户自行承担全部责任，本站不承担任何责任。如用户发现帐号遭到未授权的使用或发生其他任何安全问题，应立即修改帐号密码并妥善保管，如有必要，请通知本站。因黑客行为或用户的保管疏忽导致帐号非法使用，本站不承担任何责任。</p>
	<h3>四、使用规则</h3>
		...
		<p>&nbsp;&nbsp;&nbsp;4.2、用户对其自行发表、上传或传送的内容负全部责任，所有用户不得在本站任何页面发布、转载、传送含有下列内容之一的信息，否则本站有权自行处理并不通知用户，一切后果由用户承担：
				</p>
					<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(1)违反宪法确定的基本原则的；</p> 
		...
		<h3>五、隐私保护</h3>
				<p>&nbsp;&nbsp;&nbsp;5.1、本站不对外公开或向第三方提供单个用户的注册资料及用户在使用网络服务时存储在本站的非公开内容，但下列情况除外：
				</p>
					<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(1)事先获得用户的明确授权；</p>
					<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(2)根据有关的法律法规要求；</p>
					<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(3)按照相关政府主管部门的要求；</p>
	...
	<h3>六、版权声明</h3>
		...
		<p>&nbsp;&nbsp;&nbsp;6.3、使用本站的任何内容均应注明“来源于唐山家庭教育网”及署上作者姓名，按法律规定需要支付稿酬的，应当通知本站及作者及支付稿酬，并独立承担一切法律责任。</p>
	...
	<h3>七、责任声明</h3>
		<p>&nbsp;&nbsp;&nbsp;7.1、用户明确同意其使用本站网络服务所存在的风险及一切后果将完全由用户本人承担，唐山家庭教育网对此不承担任何责任。 </p>
	...
	<h3>八、附则</h3>
		...
		<p>&nbsp;&nbsp;&nbsp;8.3、本协议解释权及修订权归唐山市睿智文化交流有限公司所有。</p>
</div>
</body>
</html>
