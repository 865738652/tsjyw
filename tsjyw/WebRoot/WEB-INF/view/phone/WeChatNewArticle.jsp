...
<html xmlns="http://www.w3.org/1999/xhtml" data-dpr="2" style="font-size: 108px;"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <!-- 样式重置 -->
    <link rel="stylesheet" href="../newphone/newphonearticle/css/reset.css">
    <!-- lib.flexible -->
    ...
    <script type="text/javascript" src="../newphone/newphonearticle/js/flexible.js"></script>
    <script type="text/javascript" src="../newphone/newphonearticle/js/flexible_css.js"></script>
    ...
    <script type="text/javascript" src="../newphone/newphonearticle/js/makegrid.js"></script>
    <!-- lib.jquery -->
    <script type="text/javascript" src="../newphone/newphonearticle/js/jquery.min.js"></script>
    <script type="text/javascript" src="../newphone/newphonearticle/js/touch.min.js"></script>
	<script type="text/javascript" src="../newphone/newphonearticle/js/jwolf-1.2.js"></script>
    <script type="text/javascript" src="../newphone/newphonearticle/js/datecommon.js"></script>
    <title>唐山家庭教育网</title>
    
    <!--meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no"-->
    <meta name="author" content="zhangtao">
    <!--public css-->
    <link rel="stylesheet" href="../newphone/newphonearticle/css/public.css">
    <!--global js-->
    <script src="../newphone/newphonearticle/js/acc_public.js"></script>
    <script type="text/javascript" src="../newphone/newphonearticle/js/global.js"></script>
    <!--component css&&js-->
    <link rel="stylesheet" href="../newphone/newphonearticle/css/swiper.min.css">
    <script type="text/javascript" src="../newphone/newphonearticle/js/swiper.min.js"></script>
    
<link rel="stylesheet" href="../newphone/newphonearticle/css/swiper.min.css">
<script type="text/javascript" src="../newphone/newphonearticle/js/swiper.min(1).js"></script>
<!--private css&&js-->
<link rel="stylesheet" href="../newphone/newphonearticle/css/list-item.css">
<script type="text/javascript" src="../newphone/newphonearticle/js/swiper-logic.js"></script>
...
<div class="header-top">
    ...
    <div class="search">
        <img src="../newphone/newphonearticle/img/h-search.png">
    </div>
</div>
...
<div class="header-nav">
    <ul>
        <li class="nav-item on" data-urlpath="WeChatNewArticle">热点</li>
        ...
        <li class="nav-item" data-urlpath="WeChatSchool">校园</li>
    </ul>
</div>
    ...
    <c:if test="${empty sessionScope.userId}">
	    <div class="login-warn">
			<section>
				...
				<a class="close-warn">
					<img src="../newphone/newphonearticle/img/close.png">
				</a>
			</section>
		</div>
    </c:if>
    <c:choose>
    	<c:when test="${not empty moduleId}">
    		<input type="hidden" value="${moduleId}" id="hiddenmoduleId"/>
    	</c:when>
    	<c:otherwise>
    		<input type="hidden" value="-1" id="hiddenmoduleId"/>
    	</c:otherwise>
    </c:choose>
...
<div class="swiper-view">
			...
			<div class="swiper-container swiper-container-horizontal">
				<div class="swiper-wrapper" style="transform: translate3d(-4047px, 0px, 0px); transition-duration: 0ms;">
                    ...
                    <div class="swiper-slide" style="width: 1349px;">
                        <a href="http://news.87870.com/xinwennr-17085.html">
                            <img class="head-slider" src="../newphone/newphonearticle/img/7d8b11e8-b1ae-413b-aafa-70a795e1383f.jpg" width="100%">
                            <div class="swiper-title">
                                <p class="swiper-title-text">VR风投现状:机会与挑战并存 大众普及为行业主题</p>
                            </div>
                        </a>
                    </div>
                     -->
                    ...
                    <c:forEach var="article" items="${articleSilde}">
                    	<div class="swiper-slide" style="width: 1349px;">
	                        <a href="WeChatArticleDetial?articleId=${article.articleId}">
	                            <img class="head-slider" src="${article.imagePath}" width="100%">
	                            <div class="swiper-title">
	                                <p class="swiper-title-text"><c:out value="${article.articleTitle}"/></p>
	                            </div>
	                        </a>
                    	</div>
                    </c:forEach>
                            ...
                            <div class="item-description">
                                ...
                                <div class="description-info">
                                    ...
                                    <div class="info-look-count fr">
                                        <img class="fl" src="../newphone/newphonearticle/img/tlak-icon.png">
                                        <p class="fl">0</p>
                                    </div>
                                </div>
                            </div>
                            <div class="item-picture">
                                <img src="../newphone/newphonearticle/img/fe4201a7-219d-4851-b48d-9d5a47e17fa0.jpg">
                            </div>
                        </a>
                    </li>
                     -->
    ...
    <script src="../newphone/newphonearticle/js/DataLazyLoad.js"></script>
    <script src="../newphone/newphonearticle/js/index.js"></script>

    <div id="goTop">
		<img src="../newphone/newphonearticle/img/top.png">
	</div>
...
<li>
    ...
    <script type="text/javascript" src="../newphone/newphonearticle/js/public.js"></script>
