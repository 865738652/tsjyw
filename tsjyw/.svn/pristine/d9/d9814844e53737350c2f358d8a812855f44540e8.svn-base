	...
	if($.Datatype){
		...
		$.extend($.Datatype,{
			...
			*/
			...
			"qq":/^[1-9][0-9]{4,}$/,
			//手机号码;
			"m": /^(13[0-9]|15[0-9]|17[0-9]|18[0-9]|14[57])[0-9]{8}$/,//手机号
...
$(function(){
	$("input").keypress(function(e){
		...
		if(keycode==32||keycode==38||keycode==63) 
		return false;
	})
})
