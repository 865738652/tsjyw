...
<head>
    ...
    <script type="text/javascript"> 
    	...
    	$(function(){
    		...
    		loadExchangeRecord();
    		bindSelect("exchangeRecordStateId", "../AllExchangeRecordManage/getExchangeRecordForSelect", null, "exchangeRecordStateId", "exchangeRecordStateName", "", "", "全部");
    	});
				        ...
				        
				        {
		                    ...
		                    formatter:function(value,row,index){
		                    	var a = '<a class="btn btn-info" data-toggle="modal" data-target="#showExchangeRecordDialog" href="javascript:void(0);" onclick=\"showExchangeRecord('+value+')\">';
	                   			...
	                   			var f = '<i class="glyphicon glyphicon-chevron-right icon-white"></i>确认已收货</a> ';	
	                        	return a+b+c+d+e+f;  
		                  	}
                  		}				        
				]
		...
		function showExchangeRecord(exchangeRecordId)
   		{
   			$.ajax({
				url:"../AllExchangeRecordManage/getExchangeRecordById",			
...
<body>
    ...
    <div class="ch-container">
        ...
        <ul class="breadcrumb">
            ...
            <li>
                <a href="ExchangeRecordManage">我的订单</a>
            </li>
        </ul>
    </div>
    <div class="row">
