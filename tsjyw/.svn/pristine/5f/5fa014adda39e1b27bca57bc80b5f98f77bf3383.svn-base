...
<head>
   ...
   <script type="text/javascript">
       ...
       function initdata() {
			var url = "../Index/searchFamousTeacher";
		    var parms = {
...
<body class="game-body">
    <input type="hidden" id="columnindex" value="6" />
    ...
    <div class="w1170 bc clearfix">
        ...
        <div class="slide-bar">
            <div class="selected-wrap">
                <h2 class="selected-h2">挑选名师</h2>
                <!-- 
                <h3 class="selected-h3">成长阶段</h3>
                <div class="select-h3Wrap clearfix" id='ageLevel'>
                	<a href="#" class="cur" onclick="onSelectAgeLevel(this, '')">全部</a>
