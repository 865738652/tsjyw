...
<head>
    ...
    <script type="text/javascript">
		...
		function loadArticle()
		{
				 	...
				 	{		 	
				 		...
				 		formatter:function(value,row,index){
				 			var a = '<a class="btn btn-info" href="../Index/ShowArticle?articleId=' + value + '">';
	                   		...
	                   		var c = '<a class="btn btn-info" href="Article?blog=1&schoolid=-1&articleid=' + value + '">'; 
			...
			bindSelect("moduleId", "../ModuleManage/getChildModule", {parentId: 72}, "moduleId", "moduleName", "", "", "全部");
		}
		
		function addArticle() {
			window.location.href = 'Article?blog=1&schoolid=-1';
		}
...
<div class="box-content">                
      <a href='#' class="btn btn-info " onclick='addArticle()'>写文章</a>              
 </div>
