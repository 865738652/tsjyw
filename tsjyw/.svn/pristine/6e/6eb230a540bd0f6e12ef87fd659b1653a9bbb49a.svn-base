...
<div class="header-nav">
    <ul>
        ...
        <li class="nav-item on" data-urlpath="WeChatVolunteer">志愿者</li>
        <li class="nav-item" data-urlpath="WeChatNewHotAskQuestion?pno=1">问答</li>
...
<div class="swiper-view">
    ...
    <script src="../newphone/volunteer/js/index.js"></script>
